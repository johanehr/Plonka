...
public class LoginDataSource {
     ...
     * @return Result<LoggedInUser> Result object containing the logged in user on success, else an error
     */
    ...
    /**
     * Logs out the user. Currently not implemented (simply close the app entirely and log in again)
     * @return void
     */
    public void logout() {
